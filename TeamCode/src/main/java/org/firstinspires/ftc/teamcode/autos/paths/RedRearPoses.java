...
public class RedRearPoses {
    ...
    public static final Pose[] POSES = {
            ...
            new Pose(100.134, 34.169, Math.toRadians(180)),
            new Pose(126.276, 34.169, Math.toRadians(180)),

            new Pose(86.335, 12.547, Math.toRadians(68)),


            new Pose(103.35, 18.547, Math.toRadians(180)),
            new Pose(134.276, 12, Math.toRadians(180)),

            new Pose(106, 34, Math.toRadians(90)),

            new Pose(100.134, 58.169, Math.toRadians(180)),
