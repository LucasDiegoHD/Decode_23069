...
public class HuskyConstants {
    ...
    public static double TARGET_DISTANCE_INCHES = 6.0; // Distância que o robô deve parar da bola
    public static double CENTER_X_PIXELS = 160.0;      // Centro horizontal da tela (320x240)

    // --- Ganhos PID (Alinhamento) ---
    public static double TURN_KP = 0.004;  // Força do giro por erro de pixel
    public static double TURN_KI = 0.0;
    public static double TURN_KD = 0.0001;

    // --- Ganhos PID (Aproximação) ---
    public static double DRIVE_KP = 0.05;  // Força do drive por erro de polegadas
